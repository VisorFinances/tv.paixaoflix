    ...
    <div className="min-h-screen bg-background">
      ...
      <main className={`transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'} md:ml-64`}>
        ...
        <div className="px-4 py-8">
          ...
          <MovieRow
            title="Cinema"
            movies={movies.filter(m => m.type === 'movie').slice(0, 10)}
            onPlay={handlePlay}
          />
          ...
          <MovieRow
            title="Ao Vivo"
            movies={liveChannels.map(channel => ({
              id: channel.id,
              title: channel.name,
          ...
          <MovieRow
            title="Kids"
            movies={movies.filter(m => m.genre?.toLowerCase().includes('animation') || m.genre?.toLowerCase().includes('kids')).slice(0, 10)}
            onPlay={handlePlay}
            onSeriesClick={handleSeriesClick}
          />
          ...
          <MovieRow
            ...
            movies={movies.filter(m => m.genre?.toLowerCase().includes('action') || m.genre?.toLowerCase().includes('adventure')).slice(0, 10)}
            onPlay={handlePlay}
            onSeriesClick={handleSeriesClick}
          />
          ...
          <MovieRow
            ...
            movies={movies.filter(m => m.genre?.toLowerCase().includes('animation')).slice(0, 10)}
            onPlay={handlePlay}
            onSeriesClick={handleSeriesClick}
          />
          ...
          <MovieRow
            ...
            movies={movies.filter(m => m.genre?.toLowerCase().includes('romance')).slice(0, 10)}
            onPlay={handlePlay}
            onSeriesClick={handleSeriesClick}
          />
          ...
          <MovieRow
            ...
            movies={movies.filter(m => m.year && m.year < 2010).slice(0, 10)}
            onPlay={handlePlay}
            onSeriesClick={handleSeriesClick}
          />
          ...
          <MovieRow
            ...
            movies={movies.filter(m => m.year === 2025).slice(0, 10)}
            onPlay={handlePlay}
            onSeriesClick={handleSeriesClick}
          />
          ...
          <MovieRow
            ...
            movies={movies.filter(m => m.genre?.toLowerCase().includes('novela')).slice(0, 10)}
            onPlay={handlePlay}
            onSeriesClick={handleSeriesClick}
          />
        </div>
