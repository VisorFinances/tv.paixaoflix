...
class PaixaoFlixApp {
    ...
    async loadData() {
        try {
            ...
            this.data = {
                ...
                kidsMovies: kidsMoviesData || [],
                kidsSeries: kidsSeriesData || []
            };
    ...
    renderContentSections() {
        ...
        this.renderSection('preparePipoca', this.getRandomContent(5));
        this.renderSection('melhores2025', this.filterByYear(this.data.cinema, '2025'));
        this.renderSection('lancamentos2026', this.filterByYear(this.data.cinema, '2026'));
        this.renderSection('animacao', this.filterByGenre(this.data.cinema, 'Animação'));
        this.renderSection('acao', this.filterByGenre(this.data.cinema, 'Ação'));
        this.renderSection('comedia', this.filterByGenre(this.data.cinema, 'Comédia'));
        this.renderSection('drama', this.filterByGenre(this.data.cinema, 'Drama'));
        this.renderSection('terror', this.filterByGenre(this.data.cinema, 'Terror'));
        this.renderSection('romance', this.filterByGenre(this.data.cinema, 'Romance'));
